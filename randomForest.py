...
def tuningFunction(estimators, trainNumber, features, groundTruth):
    # Initialize classifier
    rFC = RandomForestClassifier(max_depth=None, random_state=None)
    ...
    # Whatever this block does
    RandomForestClassifier(bootstrap=True, class_weight=None, criterion='gini', max_depth=3, max_features='auto', max_leaf_nodes=None, min_impurity_split=None, min_samples_leaf=1,  min_samples_split=2, min_weight_fraction_leaf=0.0, n_estimators=estimators, n_jobs=1, oob_score=False, random_state=0, verbose=0, warm_start=False)
